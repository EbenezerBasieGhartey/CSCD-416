...
"HTTP_ACCEPT_LANGUAGE", "HTTP_CONNECCTION", "HTTP_HOST", "HTTP_USER_AGENT", "PATH",
...
int main(){
	...
	cout<<"<html>\n";
	cout<<"<head>\n";
	cout<<"<title> Environment Variables</title>\n";
	cout<<"</head>\n";
	cout<<"<body>\n";
	cout<<"<table border = \"0\" cellspacing = \"2\">";
	for (int i=0; i<24; i++){
		cout<< "<tr><tr>" <<ENV[i] <<"</td><td>";
		//retieve value of environment variables
		...
		if (value !=0){
			...
			cout<<"environment variables does not exist";
		}
		cout<<"</td></tr>\n";
	}
